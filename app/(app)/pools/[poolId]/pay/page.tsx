...
/**
 * Pay flow — full page on mobile, centered max-width 560px on desktop.
 *
 * The flow is purely instructional today (matching the design's three-step
 * card): the user sends money via their bank app, shares the receipt in the
 * pool's WhatsApp group, then waits for an admin to confirm. Slice 2 ships
 * no "I sent it" Server Action — the design's three-step card is read-only.
 */
